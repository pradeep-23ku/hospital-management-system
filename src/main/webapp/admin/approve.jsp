		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="text-center fs-4">Patient Approval</p>
						...
						%>
						<form class="row" action="../approve" method="post">
							...
							<div class="col-md-12">
								...
								<!-- <textarea required name="comm" class="form-control" row="3" value="confirm"
									cols=""></textarea> -->
									
									 <input type="text" readonly
									value="confirm" class="form-control" name="comm">
							</div>
