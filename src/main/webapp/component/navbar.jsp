...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  <div class="container-fluid">
    <a class="navbar-brand fs-2" href="index.jsp" >  <i class="fa-sharp fa-solid fa-house-medical"></i> PRINCE MEDICARE</a>
...
<!--        <a class="active" href="index.jsp">  <i class=" "></i> ABOUT</a> -->
        ...
        <!-- <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="demo_user_appointment.jsp">APPOINTMENT</a>        
        </li>
      ...
      <%--   
         <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
           data-bs-toggle="dropdown" aria-expanded="false">
           <i class="fa-regular fa-user"></i> ${userObj.fullName} </a>
