						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Age</label> <input
									required type="text" maxlength="2" size="2" pattern="[0-9]{2}" class="form-control" name="age" >
							</div>

							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Appointment
									Date</label> <input type="date" class="form-control" required
									name="appoint_date" min="2022-12-13" >
							</div>
							...
							<div class="col-md-6">
								...
								<select class="form-control" name="atime" required>
									<option value="">-select-</option>
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Email</label> <input
									required type="email" class="form-control" name="email" pattern=".+@gmail\.com">
									<!-- <input
									required type="text" class="form-control" name="email" pattern=".+@gmail\.com"> -->
							</div>

							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Phone No</label> <input
									maxlength="10" required type="text" class="form-control"
									name="phno"  size="10" pattern="[0-9]{10}" placeholder="Enter 10-Digit mobile number">
							</div>
